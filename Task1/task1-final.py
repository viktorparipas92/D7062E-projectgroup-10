...
# + colab={"base_uri": "https://localhost:8080/", "height": 300} id="paURPIp3m62b" outputId="4b22de09-f76e-4f25-8e2d-9d356e7ca70d" pycharm={"name": "#%%\n"}
training_features.head()

# + [markdown] id="DYPTNtFmm62c" pycharm={"name": "#%% md\n"}
# How many different labels do we have in the training dataset?

# + colab={"base_uri": "https://localhost:8080/"} id="l8hDw1bgm62c" outputId="7f333633-1d1c-4483-8fbc-0c1f9acf96a4" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/", "height": 322} id="_O-CkrFfm62d" outputId="ad9afcd5-4836-4ad1-fa9b-7d7a5aa5954e" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/"} id="rTfhsEE8m62f" outputId="62eb3157-0b72-4f9c-a1bf-91cf110ced34" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/", "height": 337} id="r77J-ZiOm62k" outputId="0bddf0cf-5a7c-4708-823f-a73359d67ac3" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/", "height": 281} id="j2OIbvJTm62l" outputId="9170fed3-adf5-4aab-e724-f6e342249732" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/", "height": 337} id="oDGrLk2Jm62l" outputId="3145fc38-ed0e-4bd3-f389-77c2a98ec641" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/", "height": 332} id="3-dLLDaPm62g" outputId="66d2de3f-72c3-4e08-80cc-832bca38404b" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/"} id="v14LUk-Km62i" outputId="3a6b15cc-155c-4759-bd5f-40c0ce506048" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/"} id="FscTkmDLm62i" outputId="c888a8ae-11c4-450b-d89f-b553060a65ea" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/", "height": 265} id="Ne7NYuHXm62i" outputId="53fa39df-ee95-4aac-a6d6-c46eef07f36a" pycharm={"name": "#%%\n"}
differences = (
    training_data_mean_imputed.values[all_na_values]
    - training_data_knn_imputed.values[all_na_values]
)
...
# + colab={"base_uri": "https://localhost:8080/", "height": 297} id="WGeg5UJDm62j" outputId="7b4edc51-7010-4610-f78f-8f5fcdde7b0b" pycharm={"name": "#%%\n"}
...
# + colab={"base_uri": "https://localhost:8080/", "height": 337} id="zZ8mc_GWm62k" outputId="2af47191-5b38-4fc8-f431-1002b2a0cc98" pycharm={"name": "#%%\n"}
training_features.boxplot(figsize=(18, 7))
plt.xticks([1], [''])
...
# + colab={"base_uri": "https://localhost:8080/", "height": 300} id="aeXO-9R9m62k" outputId="3e3b1dda-14ed-4bb7-f572-190ac361ba85" pycharm={"name": "#%%\n"}
